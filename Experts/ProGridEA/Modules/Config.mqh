//+------------------------------------------------------------------+
//|                                                      Config.mqh  |
//|                        ProGridEA – Configuration & Input Params   |
//|                                                                  |
...
input double   InpStopLoss            = 200.0;   // Stop-loss in points (0 = none)
input double   InpTakeProfit          = 400.0;   // Take-profit in points (0 = none)
